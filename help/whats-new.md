...
| [Périphériques et plateformes pris en charge](https://experienceleague.adobe.com/docs/media-analytics/using/supported-devices.html) | 18 juin 2020 | L’[!UICONTROL extension Media Launch] avec SDK mobile AEP prend désormais en charge les appareils OTT suivants :<ul><li>Apple TV (tvOS)</li><li>Fire TV (Système d’exploitation Fire)</li><li>Android TV</li></ul> |
