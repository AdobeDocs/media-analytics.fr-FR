...
| [Périphériques et plateformes pris en charge](https://experienceleague.adobe.com/docs/media-analytics/using/supported-devices.html) | 19 février 2019 | Les versions de plateforme minimales prises en charge pour chaque SDK sont répertoriées ci-dessous. <br>- iOS : iOS 6+ <br>- Android : Android 5.0+ - Lollipop <br>- Chrome : v22+<br>- Mozilla : v27+<br>- Safari : v7+<br>- IE : v1+ |
