...
description: Découvrez comment configurer Adobe Debug, que vous pouvez utiliser pour résoudre les problèmes d’implémentation de Media SDK.
...
1. Importez le certificat
   ...
   **Appareils iOS**
   1. Définissez votre appareil iOS pour utiliser Adobe Debug comme proxy HTTP en cliquant sur **[!UICONTROL Paramètres de l’application]** **>** **[!UICONTROL Paramètres Wifi]**.
