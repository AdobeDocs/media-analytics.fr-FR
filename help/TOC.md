...
user-guide-description: Implémentation d’Adobe Analytics for Streaming Media. Découvrez le SDK Media et l’API Media Collection.
...
+ Rapports et analyses {#media-reports}
   ...
   + [Modèles d’espace de travail multimédia](media-reports/media-workspace-templates.md)
...
+ Suivi de l’état du lecteur {#player-state-tracking}
   ...
   + [Suivi de plusieurs états du lecteur](sdk-implement/player-state-tracking/multiple-player-states.md)
   + [Exemples de suivi de l’état du lecteur](sdk-implement/player-state-tracking/player-state-examples.md)
+ [Federated Analytics](federated-analytics.md)
+ Ressources supplémentaires {#additional-resources}
   + [Notes de mise à jour](additional-resources/release-notes.md)
