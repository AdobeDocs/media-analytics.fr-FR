---
seo-title: Plusieurs dispositifs de suivi VOD en parallèle
...
This scenario is identical to the [VOD playback with no ads](../../sdk-implement/tracking-scenarios/vod-no-intrs-details.md) scenario, except there are two sessions that are running in parallel for two separate medias. Chacune de ces sessions utilise une instance séparée de `MediaHeartbeat`.

Sauf indication, les appels réseau sont identiques à ceux du scénario de [lecture VOD sans publicité](../../sdk-implement/tracking-scenarios/vod-no-intrs-details.md).
