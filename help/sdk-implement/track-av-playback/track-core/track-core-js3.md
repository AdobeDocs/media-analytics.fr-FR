...
1. **Configuration initiale du suivi**
   ...
   | `streamType` | string | [Type]de diffusion (lien vers les constantes streamType) ou chaîne non vide pour indiquer le type de diffusion multimédia. |
   | `mediaType` | [MediaType](lien vers les constantes MediaType) | Type de média (audio ou vidéo). |
