...
Les informations de cette page comprennent des liens pour télécharger les SDK Media 3.x et 2.x actuels. Des liens sont également inclus pour les SDK Media hérités 1.x et l’extension Media Analytics pour Launch.
...
| Chromecast | [SDK Media pour Chromecast v3.0.3](https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/chromecast-v3.0.2) | [Référence à l’API Chromecast](https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/chromecast-v3.0.3) | [Configuration de Chromecast ](/help/sdk-implement/setup/set-up-chromecast.md) |
...
| Roku | [SDK Media pour Roku v2.2.6](https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/roku-v2.2.6) |  | [Configuration de Roku](/help/sdk-implement/setup/set-up-roku.md) |
