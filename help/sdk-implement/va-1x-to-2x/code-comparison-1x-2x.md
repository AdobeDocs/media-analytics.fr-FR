---
seo-title: Comparaison du code 1. x à 2. x
title: Comparaison du code 1. x à 2. x
...
* `AdobeHeartbeatPluginConfig.sdk` - Renommé `MediaConfig.appVersion`
* `MediaHeartbeatConfig.playerName` - Maintenant défini au `MediaHeartbeatConfig` lieu de `VideoPlayerPluginDelegate`
...
Les sections suivantes fournissent des comparaisons de code entre 1. x et 2. x, couvrant l'initialisation, la lecture principale, la lecture de la publicité, la lecture de chapitres et certains événements supplémentaires.
...
Pour plus d’informations sur le suivi vidéo avec 2.x, voir [Suivi de la lecture vidéo principale.](../../sdk-implement/track-av-playback/track-core-overview.md)
