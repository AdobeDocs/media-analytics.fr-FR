...
| passé sur le contenu | Type <br>d’événement : Compteur | Définissez votre propre événement. |
...
| Milestone | Syntaxe de Milestone | Syntaxe | Syntaxe du lien personnalisé |
| --- | --- | --- | --- |
...
| Jalon | Syntaxe de Milestone | Syntaxe | Syntaxe du lien personnalisé |
| --- | --- | --- | --- |
...
| CPM | `CPM`: Le CPM ou le CPM chiffré (précédé du préfixe « ~ ») qui s’applique à cette lecture. | S.O. | Non disponible. |
