...
|   Mise en œuvre   | Paramètres réseau | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>  [position](./chapter-parameters.md#related_apis_section) </li> <li> **Clé API :**<br/>media.chapter.index </li> <li> ****<br/> Obligatoire : SDK : Non; API : Oui. </li> <li> **Type :**<br/>Nombre </li> <li> ****<br/> Envoyé avec : Fermeture du chapitre </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> ****<br/> Exemple de valeur : 2 </li><li> **Description:**<br/>Position (index, entier) du chapitre dans le contenu.   </li> </ul> | <ul> <li> ****<br/> Adobe Analytics : (a.media.chapter.<br/>position) </li> <li> ****<br/> Heartbeat : (l:stream:chapter_pos) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>Classification </li> <li> **Nom du rapport :**<br/>Position du chapitre </li> <li> ****<br/> Données contextuelles : (a.media.chapter.<br/>position) </li> <li> **Flux de données :**<br/> </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>position) </li> </ul> |

### Décalage de chapitre

|   Mise en œuvre   | Network Parameters | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>  [startTime](./chapter-parameters.md#related_apis_section) </li> <li> **Clé API :**<br/>media.chapter.offset </li> <li> ****<br/> Obligatoire : SDK : Non; API : Oui. </li> <li> **Type :**<br/>Nombre </li> <li> ****<br/> Envoyé avec : Fermeture du chapitre </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> ****<br/> Exemple de valeur : 58 </li><li> **Description:**<br/>Décalage du chapitre dans le contenu (en secondes) à partir du début.   </li> </ul> | <ul> <li> ****<br/> Adobe Analytics : (a.media.chapter.<br/>offset) </li> <li> **Heartbeat:**<br/> (l:stream:chapter_offset) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>Classification </li> <li> **Nom du rapport :**<br/>Décalage de chapitre </li> <li> ****<br/> Données contextuelles : (a.media.chapter.<br/>offset) </li> <li> **Flux de données :**<br/> </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>offset) </li> </ul> |

### Durée du chapitre

|   Mise en œuvre   | Paramètres réseau | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/> </li> <li> **Clé API :**<br/>media.chapter.length </li> <li> ****<br/> Obligatoire : SDK : Non; API : Oui. </li> <li> **Type :**<br/>Nombre </li> <li> ****<br/> Envoyé avec : Fermeture du chapitre </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> ****<br/> Sample Value: 486 </li><li> **Description:**<br/>Durée du chapitre, en secondes.   </li> </ul> | <ul> <li> ****<br/> Adobe Analytics : (a.media.chapter.<br/>length) </li> <li> ****<br/> Heartbeat : (l:stream:chapter_length) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>Classification </li> <li> **Nom du rapport :**<br/>Durée du chapitre </li> <li> ****<br/> Données contextuelles : (a.media.chapter.<br/>length) </li> <li> **Flux de données :**<br/> </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>length) </li> </ul> |

### Chapitre

|   Mise en œuvre   | Paramètres réseau | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>Définie automatiquement </li> <li> **Clé API :**<br/>S.O. </li> <li> **Obligatoire :**<br/>Non </li> <li> **Type :**<br/>Chaîne </li> <li> ****<br/> Envoyé avec : Fermeture du chapitre </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> **Sample Value:**<br/> </li><li> **Description:**<br/>The auto-generated ID of the chapter.   </li> </ul> | <ul> <li> **Adobe Analytics:**<br/> (a.media.chapter.<br/>name) </li> <li> **Heartbeat:**<br/> (s:stream:chapter_id) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>eVar </li> <li> **Expiration :**<br/>À l’ACCÈS </li> <li> **Nom du rapport :**<br/>Chapitre </li> <li> ****<br/> Context Data: (a.media.chapter.<br/>name) </li> <li> **Flux de données :**<br/>videochapter </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>name) </li> </ul> |
...
|   Mise en œuvre   | Paramètres réseau | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>Définie automatiquement  </li> <li> **Clé API :**<br/>S.O. </li> <li> **Obligatoire :**<br/>Oui </li> <li> **Type :**<br/>Chaîne </li> <li> **Envoyé avec :**<br/>Démarrage de chapitre </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> ****<br/> Exemple de valeur : TRUE </li><li> **Description:**<br/>The number of chapter starts.  **Important :** Si cet événement est défini, la seule valeur possible est TRUE. Si cet événement n’est pas défini, aucune valeur n’est envoyée.   </li> </ul> | <ul> <li> ****<br/> Adobe Analytics : (a.media.chapter.<br/>view) </li> <li> **Heartbeat:**<br/> (s:event:<br/>type=chapter_start) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>event </li> <li> **Report Name:**<br/> Chapter Starts g </li> <li> **Context Data:**<br/> (a.media.chapter.<br/>view) </li> <li> **Flux de données :**<br/>videochapterstart </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>view) </li> </ul> |

### Chapitre terminé

|   Mise en œuvre   | Paramètres réseau | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>Définie automatiquement  </li> <li> **Clé API :**<br/>S.O. </li> <li> **Obligatoire :**<br/>Oui </li> <li> **Type :**<br/>Chaîne </li> <li> ****<br/> Envoyé avec : Fermeture du chapitre </li> <li> **Min. Version SDK min. :** 1.3</li> <li> **Sample Value:**<br/> TRUE </li><li> **Description:**<br/>Nombre de chapitres terminés.  **Important :** Si cet événement est défini, la seule valeur possible est TRUE. Si cet événement n’est pas défini, aucune valeur n’est envoyée.   </li> </ul> | <ul> <li> **Adobe Analytics:**<br/> (a.media.chapter.<br/>complete) </li> <li> ****<br/> Heartbeat : (s:event:<br/>type=chapter_complete) </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>event </li> <li> ****<br/> Nom du rapport : Chapitre se termine g </li> <li> **Context Data:**<br/> (a.media.chapter.<br/>complete) </li> <li> **Flux de données :**<br/>videochaptercomplete </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>complete) </li> </ul> |

### passé sur le chapitre

|   Mise en œuvre   | Network Parameters | Création de rapports   |
| --- | --- | --- |
| <ul> <li> **Clé SDK :**<br/>Définie automatiquement  </li> <li> **Clé API :**<br/>S.O. </li> <li> **Obligatoire :**<br/>Oui </li> <li> **Type :**<br/>Nombre </li> <li> ****<br/> Sent with: Chapter Close </li> <li> **Min. Version SDK min. :** 1.3 </li> <li> **Sample Value:**<br/> </li><li> **Description:**<br/>The time spent on the chapter.  La valeur s’affichera au format horaire (HH:MM:SS) dans Analysis Workspace et Reports &amp; Analytics. Dans les API Flux de données, Data Warehouse et Création de rapports, les valeurs seront exprimées en secondes. <br/>**Date de publication : 13/09/18**   </li> </ul> | <ul> <li> ****<br/> Adobe Analytics: (a.media.chapter.<br/>timePlayed) </li> <li> **Heartbeat :**<br/> </li> </ul> | <ul> <li> **Disponible :**<br/>Oui </li> <li> **Variable réservée :**<br/>event </li> <li> **Report Name:**<br/> Chapter Time Spent g </li> <li> ****<br/> Données contextuelles : (a.media.chapter.<br/>timePlayed) </li> <li> **Flux de données :**<br/>videochaptertime </li> <li> ****<br/> Audience Manager : (c_contextdata.<br/>a.media.chapter.<br/>timePlayed) </li> </ul> |
