...
* **Mise en oeuvre du module complémentaire Collection de médias en flux continu :** L’expéditeur doit avoir mis en oeuvre le module complémentaire Collection de médias en flux continu sur tous les lecteurs qui feront partie du jeu de données fédérées. Seules les données multimédia en flux continu sont disponibles pour la fédération. Pour plus d’informations, voir [Présentation du module complémentaire Collection de médias en flux continu Adobe](/help/media-overview.md).
