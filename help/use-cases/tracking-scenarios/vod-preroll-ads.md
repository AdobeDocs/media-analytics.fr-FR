...
description: Affichez un exemple de suivi du contenu VOD contenant des publicités preroll à l’aide de Media SDK.
...
| Le contenu est lu. | | Content Heartbeats | Cet appel réseau est identique au scénario [Lecture VOD sans publicité](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md). |
| Le contenu est terminé. | `trackComplete` | Heartbeat Content Complete | Cet appel réseau est identique au scénario [Lecture VOD sans publicité](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md). |
