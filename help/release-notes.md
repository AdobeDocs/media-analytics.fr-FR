...
| Fonctionnalité | Description | Date |
| --- | --- | --- |
| **Suivi de plusieurs états du lecteur** | Utilisez l’API Media Collection pour implémenter le suivi des multiples états du lecteur. [En savoir plus](/help/implementation/events/player-state/overview.md) | Septembre 2022 |
