...
| **champ de collection XDM** | [`xdm.mediaCollection.advertisingDetails.creativeID`](https://experienceleague.adobe.com/fr/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
Définissez l’ID de contenu créatif à l’aide de `MEDIA_AdMetadataKeyCREATIVE_ID` dans l’objet de métadonnées publicitaire standard :
