...
| **champ de collection XDM** | [`xdm.mediaCollection.advertisingDetails.creativeURL`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
Définissez l’URL de création à l’aide de `MEDIA_AdMetadataKeyCREATIVE_URL` dans l’objet de métadonnées publicitaire standard :
