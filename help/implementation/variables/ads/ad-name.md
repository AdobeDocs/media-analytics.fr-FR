...
| **champ de collection XDM** | [`xdm.mediaCollection.advertisingDetails.friendlyName`](https://experienceleague.adobe.com/fr/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
Transmettez le nom de l’annonce publicitaire comme premier argument à `adb_media_init_adinfo` :
