...
| **champ de collection XDM** | [`xdm.mediaCollection.advertisingDetails.podPosition`](https://experienceleague.adobe.com/fr/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
Transmettez la position comme troisième argument à `adb_media_init_adinfo`. La position de l’annonce publicitaire dans le pod est basée sur 1 :
