...
Utilisez `MEDIA_VideoMetadataKeyEPISODE` pour définir le numéro d’épisode dans les métadonnées standard de l’objet média avant d’appeler `mediaTrackSessionStart` :
