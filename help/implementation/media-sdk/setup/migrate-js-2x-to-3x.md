---
title: Migration de JavaScript SDK 2.x vers 3.x
description: Guide de comparaison et de migration du code pour la mise à niveau de Media SDK JavaScript 2.x vers 3.x SDK.
...
# Migration de JS SDK 2.x vers JS SDK 3.x

## Nouvelles fonctionnalités

* Utilisation des API MediaCollection
* Suivi de l’état personnalisé

## Améliorations

* Fournir une configuration globale pour la bibliothèque de médias
* Création simple d’un tracker
* Ajout d’API pour fournir des informations sur le curseur de lecture et la QoE
* API pour détruire l’instance de suivi
* Simplification de la définition de métadonnées standard/personnalisées pour les médias et les publicités

## Comparaison des API

### Classe de média

| Fonctionnalité | 2.x | 3.x |
| ------ | ------ | ------ |
| **Espace de noms** | `ADB.va.MediaHeartbeat` | **`ADB.Media`** |
| **Configuration** | Paramètre `MediaHeartbeat` constructeur | **`configure(mediaConfig, appMeasurement)`** |
| **Créer un suivi** | `new MediaHeartbeat(...)` | **`getInstance()`** |
| **Méthodes statiques** | |  |
...
|  | S.O. | **`updatePlayhead(playhead)`** |
|  | S.O. | **`updateQoEObject(qoeObject)`** |
| **Détruire le suivi** | S.O. | **`destroy()`** |

### MediaConfig, classe

| Fonctionnalité | 2.x | 3.x |
| ------ | ------ | ------ |
| **Espace de noms** | ` ADB.va.MediaHeartbeatConfig` | **`ADB.MediaConfig`** |
| **Constructeur** | `new MediaHeartbeatConfig()` | **`new MediaConfig()`** |
...
### Création de la configuration et du tracker
...
### Fournir des informations sur le curseur de lecture et la qualité de service au dispositif de suivi
...
### Métadonnées standard et personnalisées pour les médias et les publicités
