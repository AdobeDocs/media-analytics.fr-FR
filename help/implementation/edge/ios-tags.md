---
title: Configuration d’iOS pour les médias en flux continu avec les balises
...
# Configuration d’iOS pour les médias en flux continu avec les balises
...
>* [Configuration d’iOS pour les médias en flux continu (dans le code)](ios.md)
