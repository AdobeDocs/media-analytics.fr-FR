...
Le décalage de chapitre est défini par le lecteur à chaque événement `media.chapterStart`.
...
| Customer Journey Analytics | [`mediaReporting.chapterDetails.offset`](https://experienceleague.adobe.com/fr/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
...
Chaque élément correspond à la valeur de décalage entière, en secondes, signalée sur `media.chapterStart`.
