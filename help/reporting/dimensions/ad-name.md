...
Le nom de l’annonce publicitaire est défini par le lecteur à chaque événement `media.adStart`.
...
Chaque élément correspond au titre de l’annonce publicitaire littérale indiqué sur `media.adStart` (par exemple, `"Ford F-150"`).
