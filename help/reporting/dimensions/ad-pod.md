...
| --- | --- |
| Adobe Analytics | Collecté automatiquement à partir des `a.media.ad.pod` de données contextuelles lorsque [[!UICONTROL Media Ads]](/help/reporting/setup/analytics-reporting.md) est activé. |
