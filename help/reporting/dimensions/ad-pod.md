...
L’ID de capsule publicitaire est généré automatiquement par le SDK lors du déclenchement de l’`media.adBreakStart`. Les implémentations directes de l’API la construisent à partir de l’index de rupture et de l’heure de début ou fournissent un identifiant de capsule personnalisé.
