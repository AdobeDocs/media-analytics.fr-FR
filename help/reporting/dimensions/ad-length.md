...
La durée de l’annonce publicitaire est définie par le lecteur à chaque événement `media.adStart`.
...
Chaque élément correspond à la valeur de la longueur de l’annonce publicitaire littérale, en secondes, signalée sur `media.adStart`.
