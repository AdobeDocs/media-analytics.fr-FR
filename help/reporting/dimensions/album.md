...
| --- | --- |
| Adobe Analytics | Collecté automatiquement à partir des `a.media.album` de données contextuelles lorsque [[!UICONTROL Métadonnées audio]](/help/reporting/setup/analytics-reporting.md) est activé. |
