...
Le serveur principal du média incrémente le décompte de chaque événement `media.bitrateChange` reçu au cours de la session. La valeur est signalée lors de l’appel de fermeture.
