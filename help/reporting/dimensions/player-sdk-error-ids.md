...
| --- | --- |
| Adobe Analytics | Collecté automatiquement à partir des `a.media.qoe.playerSdkErrors` de données contextuelles lorsque la [[!UICONTROL Qualité du média]](/help/reporting/setup/analytics-reporting.md) est activée. |
