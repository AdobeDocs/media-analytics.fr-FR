...
La longueur du chapitre est définie par le lecteur à chaque événement `media.chapterStart`.
...
Chaque élément correspond à la valeur de longueur entière, en secondes, indiquée sur `media.chapterStart`.
