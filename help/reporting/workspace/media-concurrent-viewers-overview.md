...
Vous pouvez également obtenir des données de visionneuse simultanées pendant 1 mois à la fois avec une granularité au niveau de la minute à l’aide de l’API de création de rapports Analytics 2.0.  L’API de création de rapports utilise la même définition de visionneuses simultanées qu’Analysis Workspace.  Pour plus d’informations, voir [_*Obtenir les données de rapport JSON sur les observateurs simultanés avec les API Analytics 2.0*_](/help/reporting/reports-and-analytics/get-concurrent-json20.md).
