...
Le serveur principal du média est incrémenté `mediaReporting.sessionDetails.chapterCount` chaque événement `media.chapterStart` reçu au cours de la session. La mesure est signalée lors de l’appel de fermeture.
