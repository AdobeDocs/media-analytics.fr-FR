...
description: Les sessions de comptage de données fédérées sont reçues par le biais d’un partage de données fédérées plutôt que la propre mise en œuvre d’un client.
feature: Metrics
role: User, Admin
