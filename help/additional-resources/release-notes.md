---
title: Notes de mise à jour du module complémentaire Collection de médias en flux continu
description: Affichez les notes de mise à jour du module complémentaire Collection de médias en flux continu .
...
# Notes de mise à jour du module complémentaire Collection de médias en flux continu (mai 2023)
...
## Nouvelles fonctionnalités et mises à jour dans le module complémentaire Collection de médias en flux continu Adobe {#cja-features}

| Fonctionnalité | Description | Date ciblée |
| ----------- | ---------- | ------- |
| Envoi de données web à Adobe Experience Platform Edge Network avec le SDK web | Vous pouvez désormais [utiliser le SDK Web de Adobe Experience Platform pour envoyer des données web de média en continu à Adobe Experience Platform Edge Network ;](/help/implementation/edge/edge-web-sdk.md), ce qui vous permet de créer des campagnes plus personnalisées et de fournir un contenu plus personnalisé, ce qui génère davantage de données de suivi sur lesquelles générer des rapports.<p>Avec cette amélioration, vous disposez d’une méthode de collecte unifiée pour les implémentations web couvrant toutes les solutions de la plateforme, notamment Customer Journey Analytics, RT-CDP, AJO et le transfert d’événements. Auparavant, l’API Media Edge était le seul moyen d’envoyer des données web de média en continu à l’Edge Network. | 29 mai 2024 |
| Envoi de données Roku à Adobe Experience Platform Edge | Maintenant que [installation du module complémentaire Collection de médias en flux continu avec Edge Experience Platform](/help/implementation/edge/implementation-edge.md), vous pouvez utiliser le SDK Adobe Experience Platform Roku pour envoyer des données multimédia en continu à Adobe Experience Platform. | 12 avril 2024 |
| Media Collection : intégration à Experience Edge (API et SDK Mobile) | Vous pouvez désormais utiliser l’API Experience Edge et le SDK Mobile pour mettre en oeuvre le module complémentaire de collecte de médias en flux continu Adobe, ce qui vous permet de créer des campagnes plus personnalisées et de fournir un contenu plus personnalisé, ce qui génère davantage de données de suivi sur lesquelles générer des rapports.<p>Cette amélioration fournit une méthode de collecte unifiée à l’échelle de toutes les solutions, comme les rapports Customer Journey Analytics, RT-CDP, AJO et le transfert d’événements.  [En savoir plus](/help/implementation/edge/implementation-edge.md) | samedi 12 mai 2023 |
...
## Nouvelles fonctionnalités et mises à jour dans le module complémentaire Collection de médias en flux continu Adobe {#sm-features}
