...
## Nouvelles fonctionnalités et mises à jour d’Adobe Customer Journey Analytics pour les médias en flux continu {#cja-features}
...
## Nouvelles fonctionnalités et mises à jour d’Adobe Analytics pour les médias en flux continu {#sm-features}

| Fonctionnalité | Description | Date ciblée |
| ----------- | ---------- | ------- |
| Suivi de l’état de plusieurs lecteurs | Utilisez l’API Media Collection pour mettre en oeuvre le suivi de plusieurs états du lecteur. [En savoir plus](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/multiple-player-states.html) | Septembre 2022 |
| Champs XDM renommés | Noms de champs XDM renommés pour la cohérence :<br>* Paramètres audio et vidéo<br>* Paramètres de publicité<br>* Paramètres de chapitre<br>* Paramètres d’état du lecteur<br>* Paramètres de qualité | Septembre 2022 |
| Référence de Device Co-op | Suppression de la référence à Adobe Experience Cloud Device Co-op et à l’exigence du service d’ID Experience Cloud. | Août 2022 |
| Noms de champ et chemins XDM mis à jour pour la collecte et la création de rapports | Mise à jour des éléments suivants :<br>* Paramètres audio et vidéo<br>* Paramètres de publicité<br>* Paramètres de chapitre<br>* Paramètres d’état du lecteur<br>* Paramètres de qualité | Août 2022 |
...
| Panneau Temps de lecture de média | Découvrez comment le panneau Temps de lecture de médias permet aux utilisateurs de médias de comprendre leur audience en fonction du temps de visionnage au cours de la journée selon une granularité choisie. <br>[Panneau Temps passé sur la lecture multimédia (tutoriel)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=fr) | Janvier 2022 |
