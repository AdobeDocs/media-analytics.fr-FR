...
| Panneau Observateurs simultanés de médias | Déterminez où s’est produit le pic d’accès simultanés et où des abandons ont eu lieu. Obtenez de l’aide d’insight sur la qualité du contenu et l’engagement des observateurs, ainsi que sur la résolution de problèmes ou la planification du volume et de l’échelle. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/panels/media-concurrent-viewers.html?lang=fr) | 9 août 2022 |
...
| Partage des annotations dans les cartes de performance mobiles | Vous pouvez afficher les annotations créées dans l’espace de travail sur les cartes de performance mobiles. Vous pouvez ainsi partager des nuances et informations de données contextuelles sur votre organisation et vos campagnes directement dans les projets de carte de performance mobile, visibles dans l’application mobile des tableaux de bord Analytics. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/annotations/mobile-annotations.html?lang=fr) | 15 juin 2022 |
...
| Annotations dans Analysis Workspace | Les annotations dans Workspace vous permettent de communiquer efficacement à votre organisation les nuances et informations concernant les données contextuelles. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/annotations/overview.html?lang=fr) | Le déploiement progressif commence le 23 mars 2022 |
...
| Fonctionnalité | Description | Date ciblée |
| ----------- | ---------- | ------- |
| À propos du suivi des multiple états du lecteur | Utilisez l’API Media Collection pour implémenter le suivi de plusieurs états du lecteur. [En savoir plus](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/multiple-player-states.html?lang=fr) | Septembre 2022 |
